  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      content: 'Hi! I\'m your AI Business OS assistant. Ask me anything about our automation services, pricing, or how we can help grow your business!',
      timestamp: new Date()
    }
  ])
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Ask me anything about AI Business OS and how we can automate your business!
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleSubmit} className="flex gap-2">
                <Input
                  ...
                  placeholder="Ask me anything about AI Business OS..."
                  disabled={isLoading}
                  className="flex-1"
                />
